...
public class MouseEvents extends Applet implements MouseListener {
    ...
    public void mousePressed(MouseEvent me) {
        ...
        if (me.getButton() == MouseEvent.BUTTON1) {
            ...
            circle = new Circle(rand * 20f + 5f, mouseX, mouseY, MathPIE.STATIC_BODY_DENSITY, 0.2f);
            ...
            rectangle = Polygon.generateRectangle(mouseX, mouseY, width, height, MathPIE.STATIC_BODY_DENSITY, 0.2f);
